      ...
      <div className="newimg">
        ...
        <div>
          ...
          <div className="w-11/12 md:w-9/12 mx-auto">
            <Link href="https://stitchforrmg.brac.net/" className="text-5xl font-bold title4 max-w-max hover:bg-[#de0083] hover:text-white mb-5">
            ...
            <div className="pt-5 pb-20 text-lg text-justify">
              ...
              <br />
              Each winning team will be awarded grants up to USD 30,000 to develop proof-of-concept of the solution. The winners also will receive a wide range of incubation support from BRAC Social Innovation Lab (SIL) to develop proof-of-concept of their model during the next phase.
              Here are the snapshots of the winning teams:
              <br />
...
During the incubation phase, ToguMogu will roll out the pilot at Pioneer Knitwears (BD) Ltd. (Partner Factory). 
        ...
        <div className="w-11/12 md:w-9/12 mx-auto">
          <img src="/UIC.jpg" height="200" alt="" className="design_image" />
            ...
            <Link href="http://uic.brac.net/" className="underline text-[#de0083]">Urban Innovation Challenge</Link> exists for one reason: to provide an enabling platform for young social entrepreneurs to solve some of the pressing urban challenges of our time through their entrepreneurial ventures.
            <br />
            The winners of this challenge received a wide-range of incubation support from BRAC that include pre-seed grant, office space, capability building bootcamps, mentorship, and pitching opportunity to investors. We have arranged two editions of Urban Innovation Challenge with <Link href="http://www.brac.net/program/urban-development/" className="underline text-[#de0083]">BRAC Urban Development programme</Link> so far, incubating 12 startups from their ideation stage. 
            </p>
            {/* <h2>Gallery</h2> */}
        </div>
        <div>
          <img src="/WIC.jpeg" height="200" alt="" className="design_image"/>
          ...
          <div className="w-11/12 md:w-9/12 mx-auto">
            ...
            <p className="pt-10 pb-20 text-lg text-justify">
            With this in mind, <Link href="https://www.unicef.org/rosa/where-we-work" className="underline text-[#de0083]">UNICEF ROSA</Link> and BRAC joined hands to launch the <Link href="https://www.unicef.org/rosa/water-sanitation-and-hygiene-wash/wash-innovation-challenge" className="underline text-[#de0083]">Regional WASH Innovation Challenge</Link> in 2018, calling for ideas on three categories: innovative behavioural change campaign and appropriate technologies to nudge mothers and caregivers and development of innovation systems to measure and monitor hand washing at home, schools and hospitals. More than 800 submissions were received and 55 short-listed teams were taken through a five-step WATER Challenge where they came up with unique solutions. Finally, three teams were announced as winners in the regional finale in Bhutan. 
            </p>
            {/* <h2>Gallery</h2> */}
          </div>
        </div>
